---- MODULE PROOF_016_mvcc_ssi_TTrace_1777766262 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_mvcc_ssi_TTrace_1777766262.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_mvcc_ssi_TTrace_1777766262.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_016_mvcc_ssi_TTrace_1777766262 ----
CONSTANTS
    NULL = null
    TxnId = { t1 , t2 }
    Key = { k1 , k2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 07:57:43 CST 2026