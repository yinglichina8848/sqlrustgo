---- MODULE PROOF_016_mvcc_ssi_TTrace_1777766806 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_mvcc_ssi_TTrace_1777766806.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_mvcc_ssi_TTrace_1777766806.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_016_mvcc_ssi_TTrace_1777766806 ----
CONSTANTS
    NULL = null
    Tbl = { t1 , t2 }
    t2 = t2
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 08:06:48 CST 2026