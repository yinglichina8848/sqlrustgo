---- MODULE PROOF_016_mvcc_ssi_TTrace_1777766820 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_mvcc_ssi_TTrace_1777766820.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_mvcc_ssi_TTrace_1777766820.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 12,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 13,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 14,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 15,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 16,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 17,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 18,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 19,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 20,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})]),
    ([txnStatus |-> (t1 :> "active" @@ t2 :> "active"),commitLog |-> <<>>,aborted |-> {},txnReadSet |-> (t1 :> {t1} @@ t2 :> {}),step |-> 21,store |-> (t1 :> 0 @@ t2 :> 0),txnWriteSet |-> (t1 :> {} @@ t2 :> {})])
    >>
----
...
---- CONFIG PROOF_016_mvcc_ssi_TTrace_1777766820 ----
CONSTANTS
    NULL = null
    Tbl = { t1 , t2 }
    null = null
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 08:07:09 CST 2026