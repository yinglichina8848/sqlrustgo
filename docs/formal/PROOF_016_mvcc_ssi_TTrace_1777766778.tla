---- MODULE PROOF_016_mvcc_ssi_TTrace_1777766778 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PROOF_016_mvcc_ssi_TTrace_1777766778.json", _TETrace)
...
\*
\*trace == IODeserialize("PROOF_016_mvcc_ssi_TTrace_1777766778.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PROOF_016_mvcc_ssi_TTrace_1777766778 ----
CONSTANTS
    NULL = null
    Tbl = { t1 , t2 }
    t1 = t1
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun May 03 08:06:20 CST 2026