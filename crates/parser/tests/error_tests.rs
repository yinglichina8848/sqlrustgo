...
fn test_incomplete_select() {
    ...
    assert!(
        result.is_ok(),
        "Incomplete SELECT parses as valid: {:?}",
        result
    );
}
...
fn test_unterminated_string() {
    ...
    assert!(
        result.is_ok(),
        "Parser accepts unterminated string: {:?}",
        result
    );
}
...
fn test_unterminated_double_quoted() {
    ...
    assert!(
        result.is_ok(),
        "Parser accepts unterminated quotes: {:?}",
        result
    );
}
...
fn test_invalid_operator() {
    ...
    assert!(
        result.is_ok(),
        "Invalid operator parses as valid: {:?}",
        result
    );
}
...
fn test_invalid_keyword_usage() {
    ...
    assert!(
        result.is_err(),
        "Keywords in wrong order should fail: {:?}",
        result
    );
}
...
fn test_invalid_group_by() {
    ...
    assert!(
        result.is_err(),
        "Incomplete GROUP BY should fail: {:?}",
        result
    );
}
...
fn test_invalid_order_by() {
    ...
    assert!(
        result.is_err(),
        "Incomplete ORDER BY should fail: {:?}",
        result
    );
}
...
fn test_invalid_limit() {
    ...
    assert!(
        result.is_ok(),
        "Incomplete LIMIT parses as valid: {:?}",
        result
    );
}
...
fn test_invalid_offset() {
    ...
    assert!(
        result.is_ok(),
        "Incomplete OFFSET parses as valid: {:?}",
        result
    );
}
...
fn test_invalid_on_clause() {
    ...
    assert!(
        result.is_err(),
        "Incomplete ON clause should fail: {:?}",
        result
    );
}
...
fn test_invalid_on_clause_no_condition() {
    ...
    assert!(
        result.is_ok(),
        "ON a parses as valid condition: {:?}",
        result
    );
}
...
fn test_insert_without_values() {
    ...
    assert!(
        result.is_err(),
        "INSERT without VALUES should fail: {:?}",
        result
    );
}
...
fn test_drop_table_without_name() {
    ...
    assert!(
        result.is_err(),
        "DROP TABLE without name should fail: {:?}",
        result
    );
}
...
fn test_create_table_without_columns() {
    ...
    assert!(
        result.is_ok(),
        "CREATE TABLE without columns parses: {:?}",
        result
    );
}
...
fn test_create_table_incomplete() {
    ...
    assert!(
        result.is_ok(),
        "Incomplete CREATE TABLE parses: {:?}",
        result
    );
}
...
fn test_select_multiple_from() {
    ...
    assert!(
        result.is_err(),
        "SELECT FROM without table should fail: {:?}",
        result
    );
}
...
fn test_between_invalid() {
    ...
    assert!(
        result.is_err(),
        "BETWEEN without second value should fail: {:?}",
        result
    );
}
...
fn test_intersect_incomplete() {
    ...
    assert!(
        result.is_err(),
        "Incomplete INTERSECT should fail: {:?}",
        result
    );
}
