...
fn test_create_trigger_before_insert() {
    ...
    assert!(result.is_ok(), "Failed to parse CREATE TRIGGER BEFORE INSERT: {:?}", result);
}
...
fn test_create_trigger_after_update() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TRIGGER AFTER UPDATE: {:?}", result);
}
...
fn test_create_trigger_multiple_statements() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TRIGGER with multiple statements: {:?}", result);
}

#[test]
fn test_create_trigger_referencing_old() {
    let sql = "CREATE TRIGGER trigger4 BEFORE UPDATE ON users FOR EACH ROW BEGIN SELECT OLD.name; END";
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TRIGGER with OLD: {:?}", result);
}

#[test]
fn test_create_trigger_referencing_new() {
    let sql = "CREATE TRIGGER trigger5 BEFORE INSERT ON users FOR EACH ROW BEGIN SELECT NEW.name; END";
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TRIGGER with NEW: {:?}", result);
}
...
fn test_drop_view_if_exists() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse DROP VIEW IF EXISTS: {:?}", result);
}
...
fn test_analyze_table() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse ANALYZE TABLE: {:?}", result);
}
...
fn test_optimize_table() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse OPTIMIZE TABLE: {:?}", result);
}
...
fn test_show_tables_like() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse SHOW TABLES LIKE: {:?}", result);
}
...
fn test_show_columns_from() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse SHOW COLUMNS FROM: {:?}", result);
}
...
fn test_grant_with_option() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse GRANT with multiple privileges: {:?}", result);
}
...
fn test_alter_table_add_column() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse ALTER TABLE ADD COLUMN: {:?}", result);
}
...
fn test_alter_table_rename_to() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse ALTER TABLE RENAME TO: {:?}", result);
}
...
fn test_backup_database() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse BACKUP DATABASE: {:?}", result);
}
...
fn test_restore_database() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse RESTORE DATABASE: {:?}", result);
}
...
fn test_call_procedure_with_args() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CALL with args: {:?}", result);
}
...
fn test_window_function_row_number() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse ROW_NUMBER window function: {:?}", result);
}
...
fn test_window_function_rank() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse RANK window function: {:?}", result);
}
...
fn test_window_function_dense_rank() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse DENSE_RANK window function: {:?}", result);
}
...
fn test_with_clause_multiple() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse WITH multiple CTEs: {:?}", result);
}
...
fn test_delete_with_where() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse DELETE with WHERE: {:?}", result);
}
...
fn test_delete_with_order_by_limit() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse DELETE with ORDER BY LIMIT: {:?}", result);
}
...
fn test_update_with_where() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse UPDATE with WHERE: {:?}", result);
}
...
fn test_update_multiple_columns() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse UPDATE multiple columns: {:?}", result);
}
...
fn test_create_table_with_primary_key() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TABLE with PRIMARY KEY: {:?}", result);
}
...
fn test_create_table_with_foreign_key() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TABLE with FOREIGN KEY: {:?}", result);
}
...
fn test_create_table_with_not_null() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TABLE with NOT NULL: {:?}", result);
}
...
fn test_create_table_with_unique() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TABLE with UNIQUE: {:?}", result);
}
...
fn test_create_table_with_default() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TABLE with DEFAULT: {:?}", result);
}
...
fn test_create_table_with_auto_increment() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CREATE TABLE with AUTO_INCREMENT: {:?}", result);
}
...
fn test_cast_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CAST expression: {:?}", result);
}
...
fn test_nullif_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse NULLIF expression: {:?}", result);
}
...
fn test_coalesce_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse COALESCE expression: {:?}", result);
}
...
fn test_subquery_in_select() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse subquery in SELECT: {:?}", result);
}
...
fn test_subquery_in_where() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse subquery in WHERE: {:?}", result);
}
...
fn test_exists_subquery() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse EXISTS subquery: {:?}", result);
}
...
fn test_in_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse IN expression: {:?}", result);
}
...
fn test_between_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse BETWEEN expression: {:?}", result);
}
...
fn test_like_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse LIKE expression: {:?}", result);
}
...
fn test_not_like_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse NOT LIKE expression: {:?}", result);
}
...
fn test_is_null_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse IS NULL expression: {:?}", result);
}
...
fn test_is_not_null_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse IS NOT NULL expression: {:?}", result);
}
...
fn test_case_when_expression() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CASE WHEN expression: {:?}", result);
}
...
fn test_case_when_with_multiple() {
    ...
    let result = parse(sql);
    assert!(result.is_ok(), "Failed to parse CASE WHEN with multiple conditions: {:?}", result);
}
