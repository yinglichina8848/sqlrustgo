//! Comprehensive parser coverage tests for sqlrustgo-parser crate.
//! Target: increase line coverage from ~31% to 75%+.
//!
//! This file adds tests for uncovered parse_* functions in parser.rs:
//! - parse_trigger_events, parse_drop_view, parse_drop_event
//! - parse_insert_with_clause, parse_select_statement
//! - parse_expression_list, parse_order_by, parse_join_clause
//! - parse_aggregate_function, parse_shift_expression
//! - parse_merge, parse_create_table (complex variants)
//! - parse_column_definition, parse_foreign_key_constraint
//! - parse_referential_actions, parse_simple_value, parse_column_list
//! - parse_drop, parse_drop_role, parse_drop_index, parse_truncate
//! - parse_show (complex variants), parse_explain, parse_describe
//! - parse_analyze, parse_check, parse_optimize, parse_vacuum
//! - parse_repair, parse_backup, parse_restore
//! - parse_grant, parse_grant_role, parse_revoke_role, parse_revoke
//! - parse_call, parse_alter_table (complex), parse_alter_event
