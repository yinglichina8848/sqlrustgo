...
fn test_parse_arithmetic_precedence() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse arithmetic precedence: {:?}",
        result
    );
}
...
fn test_parse_alter_table_modify_column() {
    ...
    assert!(
        result.is_ok() || result.is_err(),
        "ALTER TABLE MODIFY COLUMN test: {:?}",
        result
    );
}
...
fn test_parse_alter_table_add_constraint() {
    ...
    assert!(
        result.is_ok() || result.is_err(),
        "ALTER TABLE ADD CONSTRAINT test: {:?}",
        result
    );
}
...
fn test_parse_where_chained_and_or() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse chained AND/OR: {:?}",
        result
    );
}
...
fn test_parse_column_alias_as() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse column alias AS: {:?}",
        result
    );
}
...
fn test_parse_column_alias_no_as() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse column alias no AS: {:?}",
        result
    );
}
...
fn test_parse_column_alias_with_expression() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse expression alias: {:?}",
        result
    );
}
...
fn test_parse_select_from_database_table() {
    ...
    assert!(
        result.is_ok(),
        "Failed to parse database.table: {:?}",
        result
    );
}
