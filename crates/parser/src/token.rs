...
impl fmt::Display for Token {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Token::Optimize => write!(f, "OPTIMIZE"),
            Token::Vacuum => write!(f, "VACUUM"),
            Token::Repair => write!(f, "REPAIR"),
            Token::Duplicate => write!(f, "DUPLICATE"),
            Token::Modify => write!(f, "MODIFY"),
            Token::Excluded => write!(f, "EXCLUDED"),
            ...
            Token::Approve => write!(f, "APPROVE"),
            Token::Reject => write!(f, "REJECT"),
            Token::Device => write!(f, "DEVICE"),
            Token::Register => write!(f, "REGISTER"),
            Token::Collect => write!(f, "COLLECT"),
            Token::Data => write!(f, "DATA"),
            Token::Heartbeat => write!(f, "HEARTBEAT"),
            Token::Trusted => write!(f, "TRUSTED"),
            Token::Certificate => write!(f, "CERTIFICATE"),
            Token::Fingerprint => write!(f, "FINGERPRINT"),
            Token::Suspended => write!(f, "SUSPENDED"),
            Token::Revoked => write!(f, "REVOKED"),
            Token::SOP => write!(f, "SOP"),
            Token::Qualification => write!(f, "QUALIFICATION"),
            Token::Version => write!(f, "VERSION"),
            Token::Training => write!(f, "TRAINING"),
            Token::Bind => write!(f, "BIND"),
            Token::Active => write!(f, "ACTIVE"),
            Token::Inactive => write!(f, "INACTIVE"),
            Token::Superseded => write!(f, "SUPERSEDED"),
            Token::Valid => write!(f, "VALID"),
            Token::Expired => write!(f, "EXPIRED"),
            Token::Calibration => write!(f, "CALIBRATION"),
            Token::Pass => write!(f, "PASS"),
            Token::Fail => write!(f, "FAIL"),
            Token::Due => write!(f, "DUE"),
...
pub fn from_keyword(s: &str) -> Option<Token> {
    match s.to_uppercase().as_str() {
        ...
        "SECOND" => Some(Token::Second),
        "MINUTE" => Some(Token::Minute),
        ...
        "WORKFLOW" => Some(Token::Workflow),
        "APPROVE" => Some(Token::Approve),
        "REJECT" => Some(Token::Reject),
        "DEVICE" => Some(Token::Device),
        "REGISTER" => Some(Token::Register),
        "COLLECT" => Some(Token::Collect),
        "DATA" => Some(Token::Data),
        "HEARTBEAT" => Some(Token::Heartbeat),
        "TRUSTED" => Some(Token::Trusted),
        "CERTIFICATE" => Some(Token::Certificate),
        "FINGERPRINT" => Some(Token::Fingerprint),
        "SUSPENDED" => Some(Token::Suspended),
        "REVOKED" => Some(Token::Revoked),
        "SOP" => Some(Token::SOP),
        "QUALIFICATION" => Some(Token::Qualification),
        "VERSION" => Some(Token::Version),
        "TRAINING" => Some(Token::Training),
        "BIND" => Some(Token::Bind),
        "ACTIVE" => Some(Token::Active),
        "INACTIVE" => Some(Token::Inactive),
        "SUPERSEDED" => Some(Token::Superseded),
        "VALID" => Some(Token::Valid),
        "EXPIRED" => Some(Token::Expired),
        "CALIBRATION" => Some(Token::Calibration),
        "PASS" => Some(Token::Pass),
        "FAIL" => Some(Token::Fail),
        "DUE" => Some(Token::Due),
        "MEASUREMENT" => Some(Token::Measurement),
        _ => None,
    }
}
