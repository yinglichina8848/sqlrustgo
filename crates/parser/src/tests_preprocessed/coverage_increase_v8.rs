...
fn test_parse_optimize_table() {
    ...
    assert!(result.is_ok() || result.is_err(), "OPTIMIZE TABLE: {:?}", result);
}
...
fn test_parse_optimize_table_multiple() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "OPTIMIZE TABLE multiple: {:?}", result);
}
...
fn test_parse_check_table() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE: {:?}", result);
}
...
fn test_parse_check_table_quick() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE QUICK: {:?}", result);
}
...
fn test_parse_check_table_fast() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE FAST: {:?}", result);
}
...
fn test_parse_check_table_medium() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE MEDIUM: {:?}", result);
}
...
fn test_parse_check_table_extended() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE EXTENDED: {:?}", result);
}
...
fn test_parse_check_table_changed() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE CHANGED: {:?}", result);
}
...
fn test_parse_check_table_upgrade() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CHECK TABLE UPGRADE: {:?}", result);
}
...
fn test_parse_analyze_table() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ANALYZE TABLE: {:?}", result);
}
...
fn test_parse_analyze_table_no_write_to_binlog() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ANALYZE NO_WRITE_TO_BINLOG: {:?}", result);
}
...
fn test_parse_analyze_table_local() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ANALYZE LOCAL: {:?}", result);
}
...
fn test_parse_vacuum_table() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "VACUUM TABLE: {:?}", result);
}
...
fn test_parse_vacuum_table_full() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "VACUUM TABLE FULL: {:?}", result);
}
...
fn test_parse_vacuum_analyze() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "VACUUM ANALYZE: {:?}", result);
}
...
fn test_parse_vacuum_multiple_tables() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "VACUUM multiple tables: {:?}", result);
}
...
fn test_parse_vacuum_full_tables() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "VACUUM FULL multiple: {:?}", result);
}
...
fn test_parse_repair_table() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "REPAIR TABLE: {:?}", result);
}
...
fn test_parse_repair_table_quick() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "REPAIR TABLE QUICK: {:?}", result);
}
...
fn test_parse_repair_table_extended() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "REPAIR TABLE EXTENDED: {:?}", result);
}
...
fn test_parse_repair_table_use_frm() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "REPAIR TABLE USE_FRM: {:?}", result);
}
...
fn test_parse_backup() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "BACKUP DATABASE: {:?}", result);
}
...
fn test_parse_backup_incremental() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "BACKUP INCREMENTAL: {:?}", result);
}
...
fn test_parse_backup_differential() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "BACKUP DIFFERENTIAL: {:?}", result);
}
...
fn test_parse_backup_compressed() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "BACKUP COMPRESSED: {:?}", result);
}
...
fn test_parse_backup_all_options() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "BACKUP all options: {:?}", result);
}
...
fn test_parse_backup_without_database_keyword() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "BACKUP without DATABASE: {:?}", result);
}
...
fn test_parse_restore() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "RESTORE FROM: {:?}", result);
}
...
fn test_parse_restore_to_database() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "RESTORE TO: {:?}", result);
}
...
fn test_parse_restore_point_in_time() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "RESTORE PITR: {:?}", result);
}
...
fn test_parse_restore_database_keyword() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "RESTORE DATABASE: {:?}", result);
}
...
fn test_parse_sign_record_basic() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SIGN RECORD basic: {:?}", result);
}
...
fn test_parse_sign_record_with_columns() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SIGN RECORD with columns: {:?}", result);
}
...
fn test_parse_sign_record_string_name() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SIGN RECORD string name: {:?}", result);
}
...
fn test_parse_create_approval_policy() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE APPROVAL POLICY: {:?}", result);
}
...
fn test_parse_load_data() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "LOAD DATA INFILE: {:?}", result);
}
...
fn test_parse_load_data_duplicate() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "LOAD DATA REPLACE: {:?}", result);
}
...
fn test_parse_load_data_ignore() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "LOAD DATA IGNORE: {:?}", result);
}
...
fn test_parse_do() {
    let sql = "DO SLEEP(1)";
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "DO statement: {:?}", result);
}
...
fn test_parse_do_with_args() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "DO with args: {:?}", result);
}
...
fn test_parse_handler_read() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "HANDLER READ: {:?}", result);
}
...
fn test_parse_handler_open() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "HANDLER OPEN: {:?}", result);
}
...
fn test_parse_handler_close() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "HANDLER CLOSE: {:?}", result);
}
...
fn test_parse_alter_index() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER INDEX VISIBLE: {:?}", result);
}
...
fn test_parse_alter_index_invisible() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER INDEX INVISIBLE: {:?}", result);
}
...
fn test_parse_alter_table_rename() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER TABLE RENAME: {:?}", result);
}
...
fn test_parse_alter_table_convert() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER TABLE CONVERT: {:?}", result);
}
...
fn test_parse_alter_table_force() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER TABLE FORCE: {:?}", result);
}
...
fn test_parse_alter_table_algorithm() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER TABLE ALGORITHM: {:?}", result);
}
...
fn test_parse_alter_table_lock() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER TABLE LOCK: {:?}", result);
}
...
fn test_parse_show_extended() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW EXTENDED: {:?}", result);
}
...
fn test_parse_show_processlist() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW PROCESSLIST: {:?}", result);
}
...
fn test_parse_show_full_processlist() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW FULL PROCESSLIST: {:?}", result);
}
...
fn test_parse_show_engine() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW ENGINE: {:?}", result);
}
...
fn test_parse_show_engines() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW ENGINES: {:?}", result);
}
...
fn test_parse_show_privileges() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW PRIVILEGES: {:?}", result);
}
...
fn test_parse_show_master_status() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW MASTER STATUS: {:?}", result);
}
...
fn test_parse_show_slave_status() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW SLAVE STATUS: {:?}", result);
}
...
fn test_parse_create_database_default_charset() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE DATABASE charset: {:?}", result);
}
...
fn test_parse_create_database_collate() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE DATABASE collate: {:?}", result);
}

#[test]
fn test_parse_create_event_with_schedule() {
    let sql = "CREATE EVENT my_event ON SCHEDULE AT CURRENT_TIMESTAMP + INTERVAL 1 HOUR DO SELECT 1";
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE EVENT schedule: {:?}", result);
}
...
fn test_parse_create_event_with_repeat() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE EVENT repeat: {:?}", result);
}
...
fn test_parse_create_event_with_comment() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE EVENT comment: {:?}", result);
}
...
fn test_parse_create_event_with_enable() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE EVENT enable: {:?}", result);
}
...
fn test_parse_create_event_with_disable() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CREATE EVENT disable: {:?}", result);
}
...
fn test_parse_drop_event() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "DROP EVENT: {:?}", result);
}
...
fn test_parse_alter_event() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "ALTER EVENT: {:?}", result);
}
...
fn test_parse_cache_index() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CACHE INDEX: {:?}", result);
}
...
fn test_parse_cache_index_multiple() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CACHE INDEX multiple: {:?}", result);
}
...
fn test_parse_flush_tables() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH TABLES: {:?}", result);
}
...
fn test_parse_flush_tables_with_read_lock() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH TABLES WITH READ LOCK: {:?}", result);
}
...
fn test_parse_flush_tables_for_export() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH TABLES FOR EXPORT: {:?}", result);
}
...
fn test_parse_flush_privileges() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH PRIVILEGES: {:?}", result);
}
...
fn test_parse_flush_logs() {
    let sql = "FLUSH LOGS";
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH LOGS: {:?}", result);
}
...
fn test_parse_flush_master_keys() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH MASTER KEYS: {:?}", result);
}
...
fn test_parse_flush_status() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH STATUS: {:?}", result);
}
...
fn test_parse_flush_user_resources() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "FLUSH USER_RESOURCES: {:?}", result);
}
...
fn test_parse_kill_connection() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "KILL CONNECTION: {:?}", result);
}
...
fn test_parse_kill_query() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "KILL QUERY: {:?}", result);
}
...
fn test_parse_show_binlog_events() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW BINLOG EVENTS: {:?}", result);
}
...
fn test_parse_show_binlog_events_limit() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW BINLOG EVENTS LIMIT: {:?}", result);
}
...
fn test_parse_show_warnings() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW WARNINGS: {:?}", result);
}
...
fn test_parse_show_warnings_limit() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW WARNINGS LIMIT: {:?}", result);
}
...
fn test_parse_show_errors() {
    let sql = "SHOW ERRORS";
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW ERRORS: {:?}", result);
}
...
fn test_parse_show_errors_limit() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SHOW ERRORS LIMIT: {:?}", result);
}
...
fn test_parse_get_diagnostics() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "GET DIAGNOSTICS: {:?}", result);
}
...
fn test_parse_get_diagnostics_multiple() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "GET DIAGNOSTICS multiple: {:?}", result);
}
...
fn test_parse_resignal_with_sqlstate() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "RESIGNAL SQLSTATE: {:?}", result);
}
...
fn test_parse_resignal_with_message() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "RESIGNAL MESSAGE: {:?}", result);
}
...
fn test_parse_signal_with_info() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "SIGNAL with info: {:?}", result);
}
...
fn test_parse_case_in_where() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CASE in WHERE: {:?}", result);
}
...
fn test_parse_convert_charset() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "CONVERT USING: {:?}", result);
}
...
fn test_parse_execute_with_using() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "EXECUTE USING: {:?}", result);
}
...
fn test_parse_deallocate() {
    ...
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "DEALLOCATE: {:?}", result);
}
...
fn test_parse_group_by_grouping_sets() {
    let sql = "SELECT region, product, SUM(sales) FROM t GROUP BY GROUPING SETS((region), (product))";
    let result = parse(sql);
    assert!(result.is_ok() || result.is_err(), "GROUPING SETS: {:?}", result);
}
